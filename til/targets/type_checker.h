...
namespace til {
  ...
  protected:
    bool type_comparison(std::shared_ptr<cdk::basic_type> left, std::shared_ptr<cdk::basic_type> right, bool lax);
    void processUnaryExpression(cdk::unary_operation_node *const node, int lvl, bool acceptDoubles);
    void processBinaryArithmeticExpression(cdk::binary_operation_node *const node, int lvl);
    void processRightNodeForInt(cdk::binary_operation_node *const node, int lvl);
    void processRightNodeForDouble(cdk::binary_operation_node *const node, int lvl);
    void processRightNodeForPointer(cdk::binary_operation_node *const node, int lvl);
    void setUnspecType(cdk::typed_node *node, std::shared_ptr<cdk::basic_type> type);
